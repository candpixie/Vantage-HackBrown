        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {scenarios.map((scenario, idx) => (
            <MotionDiv
              ...
              className={`bg-white dark:bg-slate-800 border-2 rounded-xl p-6 cursor-pointer transition-all ${scenario.recommended
                ? 'border-teal-500 dark:border-teal-500 shadow-lg shadow-teal-500/30 hover:shadow-xl'
                : 'border-slate-200 dark:border-slate-700 hover:border-teal-300 dark:hover:border-teal-600 hover:shadow-md'
                }`}
            >
              {scenario.recommended && (
                <div className="text-xs font-black text-teal-600 dark:text-teal-400 uppercase mb-2 tracking-widest">
                  Recommended
                </div>
              )}
